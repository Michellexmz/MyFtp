...
class NameEditDialog(QtGui.QDialog):
	def __init__(self, parent = None):
		...
		self.layout.addWidget(self.nameLabel, 0, 0, 2, 1)
		self.layout.addWidget(self.nameEdit,  0, 1, 2, 1)
...
def nameEditDialog(parent = None):
	name = NameEditDialog(parent)
	if not name.isAccepted:
		return False
	return str(name.nameEdit.text())
